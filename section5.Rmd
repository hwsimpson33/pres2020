...
#ToDo: extend to 2016, get ad topics data from Stanford news website, check and see if cumulative nature of polls vs. non-cumulative nature of other datasets matters
```
