...
#ToDo: national linear model, state-level linear model, pooled (multilevel model), writeup
```
...
```{r state.level}
#todo: merge, linear model, predict + measure uncertainty
```

```{r pooled}
#todo: merge, model, predict + measure uncertainty
