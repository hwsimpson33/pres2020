...
model1 <- lm(attack_per ~ state.partisan + st.white + st.age + state, data = state.data)
summary(model1)

#no state fixed effects -> not significant
model2 <- lm(attack_per ~ state.partisan + st.white + st.age, data = state.data)
summary(model2)
```
...
```
```{r}
stargazer(model1, model2, header = FALSE, type = "text", 
          title = "Hypothesis 1: Partisanship and campaign ads", 
          dep.var.labels.include = FALSE, 
          dep.var.caption = c("Attack ads, percent of spending on all ads"), 
          covariate.labels = c("Partisan voter registration", 
                               "Percent white", "Percent over 65 years old"),
          omit.stat = c("f", "ser"),
          notes.label = "",
          omit = c("state"),
          add.lines = list(c("State fixed effects", "Yes", "No")))

stargazer(model3, model4, model5, model6, model7, model8, header = FALSE, type = "text",
          title = "Hypothesis 2: Partisanship and field offices",
          dep.var.labels.include = FALSE,
          dep.var.caption = c("Number of Democratic field offices"),
          covariate.labels = c("Partisan voter registration", "Percent white", "Percent over 65 years old", "Battleground", "Electoral college votes"),
          omit.stat = c("f", "ser"),
          notes.label = "",
          omit = c("state", "year"),
...
stargazer(model9, model10, model11, model12, header = FALSE, type = "text",
          title = "Hypothesis 2: Partisanship and field offices (2012 only)",
          dep.var.labels.include = FALSE,
          dep.var.caption = c("Number of Republican and Democratic field offices"),
          covariate.labels = c("Partisan voter registration", "Percent white", "Percent over 65 years old", "Electoral college votes", "Battleground"),
          omit.stat = c("f", "ser"),
          notes.label = "",
          omit = c("state"),
