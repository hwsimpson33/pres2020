...
worst.results.table <- tableHTML(worst.results.data, rownames = FALSE, border = 2, round = 4)
...
```{r}
#ToDo: calculate model confidence (z score) for each state, plot against actual victory margin, # of polls
