...
```
```{r}
#ToDo: summary stats on diff, # of states w/ zero inside margin, table of states w/ biggest errors, table of all states (link to only), calculate model confidence (z score) for each state, plot against actual victory margin, # of polls
