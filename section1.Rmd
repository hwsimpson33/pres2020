...
#ToDo: durbin-watson + density by year labels, writeup, post 
```
...
ggsave("images/extension3.png", plot = extension3_plot, height = 3, width = 7)
...
ggsave("Images/across_elections.png", plot = across_elections_plot, height = 4.5, width = 6.5)
...
ggsave("Images/autocorr.png", plot = autocorr_plot, height = 2.5, width = 4)
...
ggsave("Images/density_by_year.png", plot = density_by_year_plot, height = 4, width = 7.25)
