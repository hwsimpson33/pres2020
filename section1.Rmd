...
#ToDo: autocorrelation test, changes in mean/ variance over time histograms 
```
...
extension3.plot <- plot_usmap(data = pv_change_map, regions = "states", values = "diff") +
  facet_wrap(facets = year ~.) +
...
ggsave("extension3.png", height = 3, width = 7)
